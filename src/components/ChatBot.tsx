...
export function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "assistant", content: "Hi! 👋 I'm here to help. How can I assist you today?" }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      const resp = await fetch(CHAT_URL, {
        ...
        body: JSON.stringify({ messages: [...messages, userMsg].filter(m => m.role !== "assistant" || m.content !== "Hi! 👋 I'm here to help. How can I assist you today?") }),
      });
